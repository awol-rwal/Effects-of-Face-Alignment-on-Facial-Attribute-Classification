...
Creating the face aligned images:
...
Splitting the image dataset for all four image configurations (raw, padding=0.25, padding=0.5, and padding=0.75)
...
Run the facial attribute detection task:
